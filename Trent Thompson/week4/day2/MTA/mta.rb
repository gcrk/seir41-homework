...
def journey (sLine, sStation, fLine, fStation)
  ...
  if  number_of_stops < 0 #case going forward
      ...
      puts "forwards"
  elsif number_of_stops > 0 # case going backwards
    ...
    puts "Your journey starts on the #{sLine} and you travel through #{stationNames.join(", ")} with a total of #{number_of_stops} stops and you finish on the #{fLine} Line"

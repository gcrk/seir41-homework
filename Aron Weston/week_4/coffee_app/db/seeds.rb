Bean.destroy_all
Bean.create(:name => 'Orthodox - House Espresso Blend', :image => 'https://cdn.shopify.com/s/files/1/2350/4463/products/ORTHODOX_1000x_1bcd5e18-b640-4ca3-a2a8-cb7cf80b2e6a_1000x.png?v=1594085558', :purchase_link => 'https://stali.com.au/collections/coffee/products/st-ali-orthodox', :price => 19, :origin => 'Blend: Columbia & Brazil', :tasting_notes => 'Apple Jam | Fudge | Chocolate.', :brew_guide =>'Lorem ipsum dolor sit amet.', :roast_profile => 'Medium Roast', :aron_rating => 9)

Bean.create(:name => 'Santa Isabel Espresso', :image => 'https://marketlane.com.au/media/catalog/product/cache/1/thumbnail/421x522/9df78eab33525d08d6e5fb8d27136e95/s/a/santa_isabel_espresso_bag_image@2x.jpg', :purchase_link => 'https://marketlane.com.au/coffee-beans/espresso-coffee/santa-isabel-espresso', :price => 22, :origin => 'Single Origin: Guatemala', :tasting_notes => 'Toffee sweetness with notes of plum and orange.', :brew_guide =>'Lorem ipsum dolor sit amet.', :roast_profile => 'Medium Roast', :aron_rating => 9)

Bean.create(:name => 'Honduras | Otoniel Sagastume, Region Santa Barbara', :image => 'https://cdn.shopify.com/s/files/1/0499/3151/8107/products/honduras_1317x1317.png?v=1610599551', :purchase_link => 'https://thelittlemarionette.com/products/honduras-otoniel-sagastume-region-santa-barbara?variant=37664152191131', :price => 18, :origin => 'Single Origin: Honduras', :tasting_notes => 'Nectarine, Guava, Black Tea', :brew_guide => 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quisque volutpat mattis eros. Nullam malesuada erat ut turpis. Suspendisse urna nibh, viverra non, semper suscipit, posuere a, pede.', :roast_profile => 'Medium Roast', :aron_rating => 9)
puts "#{Bean.count} beans created."

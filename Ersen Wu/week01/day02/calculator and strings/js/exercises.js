...
//
//
//       console.log (`${num1} is the ${percent}% of ${num2}`)
// }
// percentOf (2,4);
//
...
//   const area=(Math.PI*r*r).toFixed(2);// - Bonus: Round the result so there are only two digits after the decimal.
...
// const complexCalculation = function (num){
//       const half=num/2;
//       const squre=half**2;
//       const areaOfCircle=(Math.PI*squre*squre).toFixed(2);
//       const percent=areaOfCircle/(areaOfCircle**2)*100;
//       console.log(`${percent}%`);
// }
//
...
//
//       const mixWords=function (a,b){
//
//         const aBecomes=a.replace(a.substring(0,2),b.substring(0,2));
//         const bBecomes=b.replace(b.substring(0,2),a.substring(0,2));
//         console.log('\'' + aBecomes + ' ' + bBecomes + '\'');
//       }
//         mixWords ('abc', 'def');
//       // ```
//       //
...
//       //it should add 'ing' to its end, unless it already ends in 'ing', in which case it should add 'ly' instead. If the string length is less than 3,

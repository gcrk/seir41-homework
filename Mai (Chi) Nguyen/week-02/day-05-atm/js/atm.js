...
//     let deposit = Number($('#checking-amount').val()); // pass number value
//
...
//     let withdraw = Number($('#checking-amount').val()); // pass number value
...
//     let deposit = Number($('#savings-amount').val()); // pass number value
//
//     if (deposit && deposit >= 0) { //check whether there is a number in the input and greater 0
...
//     let withdraw = Number($('#savings-amount').val()); // pass number value
//

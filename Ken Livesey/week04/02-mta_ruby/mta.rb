...
# print "What will be the line are you travelling on? "
line = "N Line"
...
start_line_index = network[line].index departure

final_point_index = network[line].index destination

journey = network[line][start_line_index..final_point_index].map.with_index { | station, index | }

journey.each do | station |
  puts " you will travel through #{ station }"
end

puts " your trip will be #{ journey.length - 1 } stops in total"
